...
namespace Taskregister.Server.Migrations
{
    ...
    [Migration("20240813131404_TagTodo")]
    partial class TagTodo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taskregister.Server.Tags.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Taskregister.Server.Todos.Entities.TagTodo", b =>
                {
            ...
            modelBuilder.Entity("Taskregister.Server.Todos.Entities.Todo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Taskregister.Server.Todos.Entities.TagTodo", b =>
                {
                    b.HasOne("Taskregister.Server.Tags.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Taskregister.Server.Todos.Entities.Todo", null)
                        .WithMany()
