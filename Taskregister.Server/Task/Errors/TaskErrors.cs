...
{
    public static Error NotFoundTaskIdForUserId(int userId, int taskId)
        => new("Tasks.NotFoundTaskIdForUserId", $"The task with Id='{taskId}' was not found for user with userId='{userId}'.");
